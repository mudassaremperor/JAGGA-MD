...
module.exports = {
    ...
    execute: async (conn, message, m, { from, reply, userPrefix, isGroup }) => {
        try {
            ...
            const NEWSLETTER_JID = "120363428198797222@newsletter";
            const NEWSLETTER_NAME = "𝗝𝗔𝗚𝗚𝗔 𝗠𝗗";
            const menuImage = 'https://files.catbox.moe/iwxvhb.jpg';

            const botName = "𝗝𝗔𝗚𝗚𝗔 𝗠𝗗";
            const ownerName = "  ִֶ‎𓆩֓⤹𝙏𝙃ع 𝙅𝘼𝙂𝙂𝘼 ⁹¹⤸֓𓆪";
            const version = "1.0";
